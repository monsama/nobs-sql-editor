...
INSERT INTO ${DB}.p VALUES (1,'a','a'),(2,'b','b'),(3,'c','c'),(4,'d','d');`);
    ...
    await G.until(() => $('res_' + i).querySelector('td input'), 3000); const inp = $('res_' + i).querySelector('td input');
    ...
    key('z');
    await G.until(() => $('res_' + i).querySelector('td input'), 3000); const one = $('res_' + i).querySelector('td input');
